...
class ItemController extends BaseController
{
    ...
    public function add(Request $request, Response $response): Response
    {
        ...
        if ($itemType == 6) {
            ...
            $boardPageId = \App\Model\Page::addPage($itemId, $pageData);
            ...
            foreach ($exampleTasks as $task) {
                ...
                $taskPageData = [
                    ...
                    'ext_info'        => json_encode(['completed' => false, 'tags' => $task['tags']], JSON_UNESCAPED_UNICODE),
                    'addtime'         => time(),
                ];
            ...
            if ($boardPageId && ($taskPageIds1 || $taskPageIds2)) {
                ...
                DB::table('page')->where('page_id', $boardPageId)->update([
